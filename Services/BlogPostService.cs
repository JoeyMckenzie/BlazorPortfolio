...
namespace Portfolio.Services
{
    public static class BlogPostService
    {
        ...
        {
            new BlogPostViewModel("Blazor Basics - Consuming External APIs from the Frontend", "https://betweentwobrackets.netlify.app/2020-04-24-blazor-basics-calling-external-apis/", new DateTime(2020, 4, 24)),
